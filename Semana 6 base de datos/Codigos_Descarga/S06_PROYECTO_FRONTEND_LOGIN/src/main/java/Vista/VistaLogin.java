...
public class VistaLogin extends javax.swing.JFrame {
    ...
    private void realizarLogin() {        
        ...
        JOptionPane.showMessageDialog(this, 
            ...
            FCancha panelCancha = new FCancha();
            
            // Limpiar el contenido actual del JFrame
            this.getContentPane().removeAll();

            // Establecer un nuevo Layout (ej. BorderLayout) para el JFrame si es necesario
            this.setLayout(new BorderLayout()); 

            // Agregar el panel FCancha a la ventana completa
            this.getContentPane().add(panelCancha, BorderLayout.CENTER);

            // Ajustar el título y tamaño si lo deseas para el nuevo contenido
            this.setTitle("Gestión de Canchas - Sistema de Gestión de Notas");
            this.setSize(new Dimension(900, 600)); // Ejemplo de nuevo tamaño
            this.setLocationRelativeTo(null);

            // 3. Repintar y revalidar la ventana para mostrar el nuevo panel
            this.revalidate();
            this.repaint();

            // Mantener la ventana visible, pero con el nuevo contenido
